...
CREATE TABLE IF NOT EXISTS PRODOTTO (
    ...
    CONSTRAINT prodotto_nome_unique UNIQUE (nome),
...
INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Romagnola', 'Prosciutto crudo, squacquerone e rucola', 7.00, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Cotto e Fontina', 'Prosciutto cotto e fontina', 6.20, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Speck e Brie', 'Speck, brie e funghi', 7.20, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Salsiccia e Cipolla', 'Salsiccia, cipolla caramellata e salsa Linda', 7.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Pollo', 'Pollo grigliato, insalata, pomodoro e maionese', 7.30, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Tonno', 'Tonno, pomodoro, insalata e maionese', 6.80, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Bresaola', 'Bresaola, rucola e grana', 7.80, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Piccante', 'Salame piccante, scamorza e peperoni', 7.10, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Caprese', 'Mozzarella, pomodoro, basilico e origano', 6.40, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Piadina Nutella', 'Piadina dolce con Nutella', 4.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;
...
INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Rotolo Kebab', 'Carne kebab, insalata, pomodoro e salsa yogurt', 7.90, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Crescione Erbe', 'Crescione con erbe e mozzarella', 5.80, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Patatine Fritte', 'Porzione di patatine fritte', 3.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Cibo'
ON DUPLICATE KEY UPDATE nome = nome;
...
INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Coca-Cola Zero', 'Lattina 33 cl', 2.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Fanta', 'Lattina 33 cl', 2.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Sprite', 'Lattina 33 cl', 2.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Te Limone', 'Bottiglietta 50 cl', 2.30, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Te Pesca', 'Bottiglietta 50 cl', 2.30, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Birra Chiara', 'Bottiglia 33 cl', 3.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;

INSERT INTO PRODOTTO (nome, descrizione, costo_prodotto, disponibilita, id_categoria)
SELECT 'Birra Artigianale', 'Bottiglia 33 cl', 4.50, TRUE, id_categoria
FROM CATEGORIA_PRODOTTO WHERE nome_categoria = 'Bevande'
ON DUPLICATE KEY UPDATE nome = nome;
...
('Scamorza', 200, 20, 'Fornitore formaggi'),
('Rucola', 200, 20, 'Fornitore generale'),
('Pomodoro', 200, 20, 'Fornitore generale'),
('Verdure grigliate', 200, 20, 'Fornitore generale'),
('Funghi', 200, 20, 'Fornitore generale'),
('Cipolla', 200, 20, 'Fornitore generale'),
('Peperoni', 200, 20, 'Fornitore generale'),
('Basilico', 200, 20, 'Fornitore generale'),
('Origano', 200, 20, 'Fornitore generale'),
('Maionese', 200, 20, 'Fornitore generale'),
('Salsa yogurt', 200, 20, 'Fornitore generale'),
('Salsa Linda', 200, 20, 'Fornitore generale'),
('Nutella', 200, 20, 'Fornitore generale'),
('Patatine', 200, 20, 'Fornitore generale'),
('Acqua naturale', 200, 20, 'Fornitore bevande'),
('Acqua frizzante', 200, 20, 'Fornitore bevande'),
('Coca-Cola', 200, 20, 'Fornitore bevande'),
('Coca-Cola Zero', 200, 20, 'Fornitore bevande'),
('Fanta', 200, 20, 'Fornitore bevande'),
('Sprite', 200, 20, 'Fornitore bevande'),
('Te Limone', 200, 20, 'Fornitore bevande'),
('Te Pesca', 200, 20, 'Fornitore bevande'),
('Birra Chiara', 200, 20, 'Fornitore bevande'),
('Birra Artigianale', 200, 20, 'Fornitore bevande')
